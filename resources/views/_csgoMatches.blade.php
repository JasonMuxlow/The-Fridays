					...
					<div class="row  mb-5">
						<div class="col mb-5">
							<div class="head-title">
								<h1 class="text-center">Counter Strike</h1>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="col-md-12 ">
			<div class="row justify-content-center">
				...
				<div class="col-sm-12 col-md-6 col-lg-2 ">
					<div class="card">
						<img src="assets/images/badassbailey.jpg"  class="card-img-top"
							 alt="...">
						<div class="card-body">
				...
				<div class=" col-sm-12 col-md-6 col-lg-2">
					<div class="card">
						<img src="assets/images/JaysiiN.jpg"  class="card-img-top"
							 alt="...">
						<div class="card-body">
				...
				<div class=" col-sm-12 col-md-6 col-lg-2 ">
					<div class="card">
						<img src="assets/images/Tenz.jpg"  class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-title">⍟Fishy</h5>
							<p class="card-text"></p>
							<a href="_fishy-player-page.blade.php" class="btn jason-button">Player Page</a>
						</div>
					</div>
				</div>
				...
				<div class=" col-sm-12 col-md-6 col-lg-2 ">
					<div class="card">
						<img src="assets/images/scraggs.jpg"  class="card-img-top"
							 alt="...">
						<div class="card-body">
							<h5 class="card-title">Scraggs</h5>
							<p class="card-text"></p>
				...
				<div class=" col-sm-12 col-md-6 col-lg-2 ">
					<div class="card">
						<img src="assets/images/KennyS.jpeg"  class="card-img-top"
							 alt="...">
						<div class="card-body">
							<h5 class="card-title">KennyS</h5>
							<p class="card-text"></p>
							<a href="_kennys-player-page.blade.php" class="btn jason-button">Player Page</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					...
					<div class="col-sm-12 col-md-6 col-lg-2 view-toggle grid-view">
						...
						<a href="_singlecsgopage.blade.php" class="btn jason-button">watch here</a>
