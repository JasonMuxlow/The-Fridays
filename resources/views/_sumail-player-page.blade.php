				...
				<div class="col-md-12">
					<div class="match-page-view">
						<div class="row">
							<div class="col-md-6">
								<div class="card">
									<img src="assets/images/sumail.jpg" height="500px" class="card-img-top" alt="...">
									<div class="card-body">
										<h5 class="card-title">Sumail</h5>
										<p class="card-text"></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="player-bio p-3">
									<ul>
										<li class="player-bio-list"> Game: Dota</li>
										<li class="player-bio-list"> Role: Pos-1</li>
										<li class="player-bio-list">AGE: 23</li>
										...
										<li class="player-bio-list">Team:
											<button class="btn jason-button">Dota</button>
