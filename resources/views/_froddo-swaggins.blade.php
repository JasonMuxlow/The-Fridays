				...
				<div class="col-md-12">
					<div class="match-page-view">
						<div class="row">
							<div class="col-md-6">
								<div class="card">
									<img src="assets/images/fordo-swaggins.jpg" height="500px" class="card-img-top" alt="...">
									<div class="card-body">
							...
							<div class="col-md-6">
								<div class="player-bio p-3">
									<ul>
										<li class="player-bio-list"> Game: League</li>
										...
										<li class="player-bio-list">Team:
											<button class="btn jason-button">League</button>
										</li>
									</ul>
								</div>
							</div>
